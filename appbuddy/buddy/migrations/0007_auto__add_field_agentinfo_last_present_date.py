...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgentInfo.last_present_date'
        db.add_column(u'buddy_agentinfo', 'last_present_date',
                      self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgentInfo.last_present_date'
        db.delete_column(u'buddy_agentinfo', 'last_present_date')
    ...
    models = {
        ...
        u'buddy.agentinfo': {
            ...
            'last_present_date': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
