...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AgentAttendance'
        db.create_table(u'buddy_agentattendance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('model_utils.fields.AutoCreatedField')(default=datetime.datetime.now)),
            ('modified', self.gf('model_utils.fields.AutoLastModifiedField')(default=datetime.datetime.now)),
            ('agent_info', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attendance', to=orm['buddy.AgentInfo'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'buddy', ['AgentAttendance'])

        # Adding field 'DownloadLog.install_count'
        db.add_column(u'buddy_downloadlog', 'install_count',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'AgentAttendance'
        db.delete_table(u'buddy_agentattendance')

        # Deleting field 'DownloadLog.install_count'
        db.delete_column(u'buddy_downloadlog', 'install_count')


    models = {
        u'buddy.agentattendance': {
            'Meta': {'object_name': 'AgentAttendance'},
            'agent_info': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'attendance'", 'to': u"orm['buddy.AgentInfo']"}),
        ...
        u'buddy.agentinfo': {
            ...
            'business_partner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agents'", 'to': u"orm['buddy.BusinessPartner']"}),
        ...
        u'buddy.appbuddyuser': {
            ...
            'install_count': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
        ...
        u'buddy.appinfo': {
            ...
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'dns_whitelist': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'proxy_whitelist': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'buddy.baseuser': {
            ...
            'type': ('django.db.models.fields.TextField', [], {'default': "'agent'", 'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'buddy.locationinfo': {
            ...
            'address': ('django.db.models.fields.TextField', [], {}),
            'agent': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'location'", 'null': 'True', 'default': 'None', 'to': u"orm['buddy.AgentInfo']", 'blank': 'True', 'unique': 'True'}),
        ...
        u'buddy.locationpartner': {
            ...
            u'baseuser_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['buddy.BaseUser']", 'unique': 'True', 'primary_key': 'True'}),
            'business_partner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'location_partners'", 'to': u"orm['buddy.BusinessPartner']"})
        },
