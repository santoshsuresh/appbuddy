...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseUser.type'
        db.alter_column(u'buddy_baseuser', 'type', self.gf('django.db.models.fields.TextField')(max_length=10, null=True))
        # Deleting field 'LocationPartner.businessPartner'
        db.delete_column(u'buddy_locationpartner', 'businessPartner_id')

        # Adding field 'LocationPartner.business_partner'
        db.add_column(u'buddy_locationpartner', 'business_partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='location_partners', to=orm['buddy.BusinessPartner']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BaseUser.type'
        db.alter_column(u'buddy_baseuser', 'type', self.gf('django.db.models.fields.TextField')(max_length=10))
        # Adding field 'LocationPartner.businessPartner'
        db.add_column(u'buddy_locationpartner', 'businessPartner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='location_partners', to=orm['buddy.BusinessPartner']),
                      keep_default=False)

        # Deleting field 'LocationPartner.business_partner'
        db.delete_column(u'buddy_locationpartner', 'business_partner_id')
