...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppInfo.dns_whitelist'
        db.add_column(u'buddy_appinfo', 'dns_whitelist',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AppInfo.proxy_whitelist'
        db.add_column(u'buddy_appinfo', 'proxy_whitelist',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'AppInfo.dns_whitelist'
        db.delete_column(u'buddy_appinfo', 'dns_whitelist')

        # Deleting field 'AppInfo.proxy_whitelist'
        db.delete_column(u'buddy_appinfo', 'proxy_whitelist')
