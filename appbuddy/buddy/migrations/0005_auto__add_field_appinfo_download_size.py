...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppInfo.download_size'
        db.add_column(u'buddy_appinfo', 'download_size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppInfo.download_size'
        db.delete_column(u'buddy_appinfo', 'download_size')
