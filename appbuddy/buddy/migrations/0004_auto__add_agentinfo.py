...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'buddy_agentinfo', (
            ...
            ('mobileNumber', self.gf('django.db.models.fields.TextField')(unique=True)),
            ...
            ('agentId', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('photograph', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('validatedOn', self.gf('django.db.models.fields.DateTimeField')()),
        ))
    ...
    models = {
        u'buddy.agentinfo': {
            ...
            'mobileNumber': ('django.db.models.fields.TextField', [], {'unique': 'True'}),
